...
class App(threading.Thread):
    def __init__(self):
        ...
        #self.url = "https://ticket.interpark.com//"
        self.url = "https://accounts.interpark.com/login/form"
    ...
    def login(self):
        def task():
            ...
            self.driver.find_element(By.ID, 'userId').send_keys(self.id_entry.get())
    ...
    def link_go(self):
        def task():
            # self.driver.get('https://tickets.interpark.com/goods/24007166')
            self.driver.get('https://tickets.interpark.com/goods/24004862')
